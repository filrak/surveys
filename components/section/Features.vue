<template>
    <main class="container mx-auto px-4 py-8">
      ...
      <section class="grid md:grid-cols-2 gap-8 items-center mb-16">
        ...
        <div>
          <img
            src="https://g-r2xql6awum4.vusercontent.net/placeholder.svg?height=300&width=400"
            alt="AI Chat Survey Interface"
            class="rounded-lg shadow-lg w-full h-auto bg-muted"
          />
        </div>
      </section>
